...
; return nothing
huffman_node_destory proc, node: ptr huffman_node
	.if node != 0
		invoke crt_free, node
	.endif
	ret
huffman_node_destory endp
...
; return nothing
pq_destory proc uses ebx ecx, q: ptr priority_queue
...
; return nothing
huffman_forest_destory proc uses ebx edx, forest: ptr huffman_node
	.if forest == 0
		ret
	.endif
	mov ebx, forest
	mov edx, [ebx + 5]
	.if edx != 0
		invoke huffman_forest_destory, edx
	.endif
	mov edx, [ebx + 9]
	.if edx != 0
		invoke huffman_forest_destory, edx
	.endif
	invoke huffman_node_destory, forest
	ret
huffman_forest_destory endp 
