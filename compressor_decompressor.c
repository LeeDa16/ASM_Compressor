...
extern void huffman_node_destroy(huffman_node * node);
//void huffman_node_destroy(huffman_node * node) {
//    if (node) {
//        free(node);
//    }
//}
...
//        huffman_node_destroy(q->nodes[i]);
//    }
//    free(q);
//}
...
//        huffman_forest_destroy(forest->left_child);
//    }
//    if (forest->right_child) {
//        huffman_forest_destroy(forest->right_child);
//    }
//    huffman_node_destroy(forest);
//}
